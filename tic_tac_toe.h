...
// the board.                                             *
// ********************************************************
void Gameplay::displayBoard(char board[][COLS])
{
...
// take a turn.                                           *
// ********************************************************
void Gameplay::playerTurn(char board[][COLS], char symbol)
{
...
// ********************************************************
bool Gameplay::gameOver(char board[][COLS])
{
...
// ********************************************************
bool Gameplay::playerWins(char board[][COLS], char symbol)
{
...
// ********************************************************
bool Gameplay::playerCanWin(char board[][COLS], char symbol)
{
	// The status flag, initialized to false.
	bool status = false;	
...
// ********************************************************
void Gameplay::displayWinner(char board[][COLS])
{
